...
const services = [
    {
        ...
        price: "R$ 50,00",
        icon: <Scissors />,
        linkText: "https://wa.me/558699641994?text=Olá, vim pelo site e gostaria de agendar um serviço de Banho & Tosa para meu pet."
    },
    {
        ...
        <section className="bg-white py-16">
            <div className="container px-4 mx-auto">
                ...
                <div className="relative">
                    ...
                    <button
                    className='bg-white flex items-center justify-center rounded-full shadow-md w-10 h-10 absolute left-3 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10'
                    onClick={scrollPrev}
                    >
                        <ChevronLeft />
                    </button>
                    ...
                    <button
                    className='bg-white flex items-center justify-center rounded-full shadow-md w-10 h-10 absolute -right-7 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10'
                    onClick={scrollNext}
                    >
                        <ChevronRight />
                    </button>
